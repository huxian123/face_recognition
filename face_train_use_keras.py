...
class Model:
    ...
    def build_model(self, dataset, nb_classes=2):
        ...
        self.model.add(Convolution2D(32, (3, 3), padding = 'same', input_shape=dataset.input_shape)) #2维卷积
        self.model.add(Activation('relu')) #激活函数层

        self.model.add(Convolution2D(32, (3, 3)))  #2维卷积
        self.model.add(Activation('relu')) #激活函数层

        self.model.add(MaxPooling2D(pool_size=(2,2))) #池化层
        self.model.add(Dropout(0.25))#Dropout层

        self.model.add(Convolution2D(64, (3, 3), padding='same')) #2维卷积
        self.model.add(Activation('relu'))  #激活函数层

        self.model.add(Convolution2D(64, (3, 3)))  #2维卷积
        self.model.add(Activation('relu'))  #激活函数层
